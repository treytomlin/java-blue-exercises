...
select name, population from city where countrycode = 'USA' and district = 'Texas' and population > 1000000
...
select (2018 - indepyear) from country where indepyear is not null